<template>
  ...
  export default {
    ...
    methods: {
      tablaContador(dataJson, imgContenedor) {
        ...
        celTotal.textContent = "Total de estaciones:";
        ...
        celDataTotal.textContent = count;
       ...
       /* console.log("Conteo de elementos repetidos:"); ---------------
        for (const id in countID) {
          console.log(`${id}: ${countID[id]}`);
        }
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            const intervaloIN = setInterval(() => {
              ...
              if (elementoIN) {
                ...
                const observer = new MutationObserver(() => {
                  ...
                  const imgContenedor =
                    iframeDocument.getElementById("imgContenedor");
  
                  const tableCount = imgContenedor.getElementById("tableCount");
                  console.log("AVERGAS ->", tableCount);
  
                  // Eliminar la imagen
                  const imagenAnterior = imgContenedor.querySelector(
                    "#imgContenedorImg img"
                  );
                  if (imagenAnterior) {
                  ...
                  axios.get(url3).then((response) => {
                    ...
                    if (
                      ...
                      urs.cTableSinData(firstItem, imgContenedorTab);
                    } else {
                      funLinksActivos(url, url2);
                ...
                /*  const imgContenedor =
                  ...
                  if (imgContenedor) {
                    // Eliminar las tablas
                    const tablasAnteriores = imgContenedor.querySelectorAll(
                      "#imgContenedorTab table"
                    );
                    tablasAnteriores.forEach((tabla) => {
                      imgContenedor.removeChild(tabla);
                    });
            ...
            /*  const imgContenedor =
              ...
              // const tablaCont = iframeDocument.getElementById("tableCount");
  ...
  /*
        ...
        const imagenAnterior =
                      imgContenedor.querySelector("img") ||
                      imgContenedor.querySelector("table");
